  ...
  return (
    <footer className="my-10">
      {contact || booking ? null : (
        <section className="flex justify-center items-center flex-wrap p-5 gap-5 rounded-lg w-[250px] md:w-[1000px] mx-auto bg-[#F78214] mb-5">
          <div>
      ...
      <main className="mt-20 md:flex justify-center gap-14 md:gap-40 text-center space-y-5">
        <div>
      ...
      <div className="w-[250px] md:w-[1100px] h-0.5 mx-auto mt-7 bg-[#8D8D8D]" />
